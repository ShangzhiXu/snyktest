...
#define xmlDictComputeKey(dict, name, len) \
    (((dict)->size == MIN_DICT_SIZE) ? xmlDictComputeFastKey(name, len, (dict)->seed) : xmlDictComputeBigKey(name, len, (dict)->seed))

#define xmlDictComputeQKey(dict, prefix, plen, name, len) \
    (((prefix) == NULL) ? (xmlDictComputeKey(dict, name, len)) : (((dict)->size == MIN_DICT_SIZE) ? xmlDictComputeFastQKey(prefix, plen, name, len, (dict)->seed) : xmlDictComputeBigQKey(prefix, plen, name, len, (dict)->seed)))
