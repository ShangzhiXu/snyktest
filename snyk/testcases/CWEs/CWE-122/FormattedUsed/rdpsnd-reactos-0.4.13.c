...
static void rdpsnd_process_negotiate(RDPCLIENT *This, STREAM in) {
  ...
  out = rdpsnd_init_packet(This, RDPSND_NEGOTIATE | 0x200,
                           20 + 18 * This->rdpsnd.format_count);
...
BOOL rdpsnd_init(RDPCLIENT *This) {
  This->rdpsnd.channel = channel_register(
      This, "rdpsnd", CHANNEL_OPTION_INITIALIZED | CHANNEL_OPTION_ENCRYPT_RDP,
      rdpsnd_process);
